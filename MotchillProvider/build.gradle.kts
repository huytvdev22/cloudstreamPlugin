...
// Cấu hình Build cho Motchill Plugin
version = 1

cloudstream {
    description = "Nguồn xem phim Vietsub, Thuyết minh từ Motchill (Phiên bản: 1.0.0 - Build: ${getGitHash()} - Ngày: ${getBuildDate()})"
    authors = listOf("HuyTV")
    status = 1 // 1: Ok, 2: Slow, 3: Beta
    tvTypes = listOf("Movie", "TvSeries", "Anime")
    requiresResources = false
    language = "vi"
    iconUrl = "https://motchillw.sh/motchill.png"
}
